...
<br/>
push를 해주고 repo에서 pull request & Merge 해주면 master 브랜치에 합병된다 <br/>
...
### 5 ) 각 팀에서 다른 팀 코드도 수정하면서 push & pull / Pull reqeust & Merge 해보자
어떤일이 일어날까
...
[gitignore.io](https://www.gitignore.io/) <br/>
<br/>
추가항목 : migrations, 가상환경 등등
